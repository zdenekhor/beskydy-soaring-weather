...
export default async function Home() {
  ...
  <div className="groundWindMain">
    <div className="groundWindSpeed">
      <span id="surfaceWindSpeed">4</span> kt
    </div>
    <div className="groundWindDir">
      <span id="surfaceWindDir">073</span>°
    </div>
  </div>
...
<div className="card runwayCard">
  ...
  <div className="runwayVisualWrap">
    <svg viewBox="0 0 320 220" className="runwaySvg">
      ...
      <g id="windArrowGroup" transform="rotate(73 160 110)">
        <line
          x1="160"
          y1="40"
          x2="160"
  ...
  <div className="runwayReadout">
    ...
    <div>
      <strong>Wind:</strong> <span id="windReadout">073° / 4 kt</span>
    </div>
    <div>
      <strong>Component:</strong>{" "}
      <span id="windComponentText">Crosswind 4 kt</span>
    </div>
  </div>
</div>
